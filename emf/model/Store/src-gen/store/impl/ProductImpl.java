 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.ProductImpl#getId <em>Id</em>}</li>
 *   <li>{@link store.impl.ProductImpl#getName <em>Name</em>}</li>
 *   <li>{@link store.impl.ProductImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link store.impl.ProductImpl#getCategory <em>Category</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductImpl extends MinimalEObjectImpl.Container implements Product {
	...
	public void setQuantity(double newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StorePackage.PRODUCT__QUANTITY, oldQuantity,
					quantity));
	}
