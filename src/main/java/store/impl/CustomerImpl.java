 ...
 * </p>
 * <ul>
 *   <li>{@link store.impl.CustomerImpl#getId <em>Id</em>}</li>
 *   <li>{@link store.impl.CustomerImpl#getName <em>Name</em>}</li>
 *   <li>{@link store.impl.CustomerImpl#getOrder <em>Order</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomerImpl extends MinimalEObjectImpl.Container implements Customer {
	...
	public EList<Order> getOrder() {
		if (order == null) {
			order = new EObjectWithInverseResolvingEList<Order>(Order.class, this, StorePackage.CUSTOMER__ORDER,
					StorePackage.ORDER__CUSTOMER);
		}
		return order;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case StorePackage.CUSTOMER__ORDER:
