...
public class StorePackageImpl extends EPackageImpl implements StorePackage {
	 ...
	 * @generated
	 */
	public EAttribute getOrder_CreatedAt() {
	...
	public void initializePackageContents() {
		...
		initEReference(getProduct_Category(), this.getCategory(), null, "category", null, 0, 1, Product.class,
		...
		initEClass(customerEClass, Customer.class, "Customer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCustomer_Id(), ecorePackage.getEInt(), "id", null, 0, 1, Customer.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(orderStateEEnum, OrderState.IN_PROCESS);
		addEEnumLiteral(orderStateEEnum, OrderState.SHIPPED);
		addEEnumLiteral(orderStateEEnum, OrderState.RECEIVED);
		addEEnumLiteral(orderStateEEnum, OrderState.SENT_BACK);
